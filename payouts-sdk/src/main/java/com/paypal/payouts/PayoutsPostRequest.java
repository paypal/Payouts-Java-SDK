...
public class PayoutsPostRequest extends HttpRequest<CreatePayoutResponse> {
    ...
    public PayoutsPostRequest payPalPartnerAttributionId(String payPalPartnerAttributionId) {
        header("PayPal-Partner-Attribution-Id", String.valueOf(payPalPartnerAttributionId));
        return this;
    }

    public PayoutsPostRequest payPalRequestId(String payPalRequestId) {
